...
\cvlistitem{Делал сайты для телеканалов СТС, ДТВ и Домашний, интернет-магазина Евродом, фотоаппаратов «Leica Camera», Связного-клуба, сети поликлиник «Семейный Доктор», клуба «\href{http://propagandamoscow.com}{Пропаганда}», кафе \href{http://filialmoscow.com/ru/}{Filial} и многих других менее известных клиентов.}
...
\section{Навыки}
\cvline{В основном}{JavaScript, CoffeeScript, Python}
\cvline{Иногда}{Ruby, bash}
\cvline{На досуге}{Clojure, Objective-C}
