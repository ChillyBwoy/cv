...
\section{Опыт работы}
\cventry{Окт 2008--по н.в.}{Программист}{Kitty Hug}{Москва}{}{Разрабатываю фронтенд и бэкенд, занимаюсь проектированием. Использую Django, MySQL и React, пишу тесты(иногда).}
...
\cvline{Редко}{Ruby (Sinatra, Ruby on Rails), bash}
\cvline{На досуге}{лениво изучаю Clojure/ClojureScript и Swift}
\cvline{Когда-то давно}{Pascal, C, C\texttt{++}, Delphi, C\texttt{\#}, PHP}
\cvline{Верстаю}{CSS/SASS/SCSS, HTML/Haml}
\cvline{Использую}{Git, vim, Sentry}
