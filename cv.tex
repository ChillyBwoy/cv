...
\firstname{Евгений}
\lastname{Чельцов}
\title{Архитектор программного обеспечения}
\date{\today}
...
\section{Опыт работы}
\cventry{Дек 2014--по н.в.}{Архитектор программного обеспечения}{Mail.Ru Group}{Москва}{}
{Разрабатываю фронтенд.}

\cvlistitem{Проектирование и разработка утилит и костылей.\newline}
\cvlistitem{Проектирование и разработка внутреннего фреймфорка.\newline}
...
\section{Навыки}
\cvline{В основном}{JavaScript/TypeScript (Vanilla JS, React/Redux, jQuery, Backbone+Marionette), \newline Python (Django, Django REST Framework)}
\cvline{На досуге}{лениво изучаю Clojure/ClojureScript}
\cvline{Когда-то давно}{Ruby (Sinatra, Ruby on Rails), bash}
\cvline{Когда-то давным-давно}{Pascal, C, C\texttt{++}, Delphi, C\texttt{\#}, PHP}
\cvline{Верстаю}{CSS/SCSS/PostCSS, HTML/bem}
...
\cventry{2002-2007}{Инженер по специальности «Программное обеспечение вычислительной техники и автоматизированных систем»}{Курский государственный технический университет (ныне ЮЗГУ Юго-Западный государственный университет)}
{}
{}
{}
