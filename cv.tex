...
\cvlistitem{Разработал клиентскую часть интерактивной презентации для \href{http://nextore.ru/projects/3}{МЧС России}. Технологии: Ruby(Sinatra), HAML, SCSS(Compass), CoffeeScript}
\cvlistitem{В сжатые сроки реализовал прототип сервиса «\href{http://dvhb.ru/evomap}{Эвомап}» с использованием Ruby(Ruby on Rails), CoffeeScript, Backbone и SCSS.}
...
\section{Навыки}
\cvline{В основном}{JavaScript/CoffeeScript (Vanilla JS, Backbone, Marionette, React, jQuery), \newline Python(Django, Tornado)}
\cvline{Иногда}{Ruby (Sinatra, Ruby on Rails), bash}
\cvline{На досуге}{Clojure, ClojureScript, Objective-C}
\cvline{Когда-то давно}{C, C\texttt{++}, C\texttt{\#}, PHP}
\cvline{Верстаю}{CSS/SASS/SCSS, HTML/Haml}
\cvline{Использую}{Git, Hg, vim}
